...
private:
    ...
    MousePos _DefaultMousePos = { 0, 0 };
    Camera* _pCam = new Camera(_pEPlayer, 1.5f * DirectX::XM_PI, DirectX::XM_PIDIV4, 5.0f, _DefaultMousePos);
};
...
void BoxApp::BuildBoxGeometry()
{
    ...
    {
        Vertex({ XMFLOAT3(-5.0f, -5.0f, -5.0f), XMFLOAT4(Colors::White) }),
        Vertex({ XMFLOAT3(-5.0f, +5.0f, -5.0f), XMFLOAT4(Colors::Black) }),
        Vertex({ XMFLOAT3(+5.0f, +5.0f, -5.0f), XMFLOAT4(Colors::Red) }),
        Vertex({ XMFLOAT3(+5.0f, -5.0f, -5.0f), XMFLOAT4(Colors::Green) }),
        Vertex({ XMFLOAT3(-5.0f, -5.0f, +5.0f), XMFLOAT4(Colors::Blue) }),
        Vertex({ XMFLOAT3(-5.0f, +5.0f, +5.0f), XMFLOAT4(Colors::Yellow) }),
        Vertex({ XMFLOAT3(+5.0f, +5.0f, +5.0f), XMFLOAT4(Colors::Cyan) }),
        Vertex({ XMFLOAT3(+5.0f, -5.0f, +5.0f), XMFLOAT4(Colors::Magenta) })
    };
